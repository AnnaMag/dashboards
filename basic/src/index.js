...
var statusRingChart = dc.pieChart("#chart-ring");
...
hitslineChart
   ...
   .renderlet(function (chart) {chart.selectAll("g.x text").attr('dx', '-30')
   .attr('dy', '-7').attr('transform', "rotate(-90)");})
...
statusRingChart
            ...
            .data(function() {return [
                {"key":"http_200","value":1450},
                {"key":"http_302","value":502},
                {"key":"http_404","value":21}];
                }
            )
            .innerRadius(30);
dc.renderAll();
